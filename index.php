...
<section class="hero_section hero_section_home" style="background:url('./assets/img/hero_section/hero_section.webp') no-repeat center/cover">
<div>
  ...
  <section class="products_main_main">
    <div class="products_main">
      ...
      <div class="products_main_content">
        ...
        <div class="products_main_points mt-5">

          <div class="products_main_point">
            <div class="products_main_img_point">
              <span>
                Tommato
              </span>
              <img src="./assets/img/products/tomotto.png" alt="">
            </div>
            <div class="products_main_point_content">
              <div class="point_content_bar">
                <input type="range" value="45" class="slider">
                <span>
  ...
  <section class="info_banner_main" style="background: url('./assets/img/home/info_bg.webp') no-repeat center center/cover;">
    <div class="info_banner">
      <div class="info_banner_point">
        <div>
          <img src="./assets/img/icon/organic.webp" alt="">
        </div>
        <div>
          <h2>
            100%
      ...
      <div class="info_banner_point">
        <div>
          <img src="./assets/img/icon/cannabis.webp" alt="">
        </div>
        <div>
          <h2>
            300+
      ...
      <div class="info_banner_point">
        <div>
          <img src="./assets/img/icon/costumer.webp" alt="">
        </div>
        <div>
          <h2>
            200+
